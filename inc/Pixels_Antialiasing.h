...
void PixelsAntialiased::drawRoundRectangleAntialiased(int16_t x, int16_t y, int16_t width, int16_t height, int16_t rx, int16_t ry, bool bordermode) {
...
void PixelsAntialiased::drawCircleAntialiaced( int16_t x, int16_t y, int16_t radius, bool bordermode )	{
